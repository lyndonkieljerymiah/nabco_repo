...
using NabcoPortal.ViewModel.Identity;
using UserDbContext = NabcoPortal.Persistent.UserDbContext;
...
namespace NabcoPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //data
            var allRoles = await _userDbContext.Roles
                .OrderBy(r => r.Name)
                .Select(rr=> new SelectListItem { Value = rr.Name.ToString(),Text = rr.Name})
                .ToListAsync();
            var register = RegisterViewModel.CreateWithRoles(allRoles);
